...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'ideas_comment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ...
        db.send_create_signal(u'ideas', ['Comment'])
        ...
        db.create_table(u'ideas_interest', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('idea', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ideas.Idea'])),
        ))
        db.send_create_signal(u'ideas', ['Interest'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'ideas_comment')

        # Deleting model 'Vote'
        db.delete_table(u'ideas_vote')

        # Deleting model 'Interest'
        db.delete_table(u'ideas_interest')
